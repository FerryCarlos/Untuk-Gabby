...
function wa(isi) 
{
	open("https://wa.me/6281283895036?text=Makasih ya udah inget hari ulang tahun aku, di hari spesial ini aku mau " + isi)
}
...
async function makeawish() 
{
	var {
		...
		imageUrl: 'assets/img/bubu-dudu-sseeyall_bear.gif',
